...
tf.flags.DEFINE_integer("batch_size", 2048, "Number of batch size")
...
tf.flags.DEFINE_string("gpus", '1', "list of gpus")
...
def main(_):
    ...
    FLAGS.model_dir = FLAGS.model_dir + FLAGS.dt_dir + "GPU"
    ...
    te_files = glob.glob("%s/small_test/*tfrecord" % FLAGS.data_dir)
    ...
    if FLAGS.task_type == 'train':
        ...
        Estimator.evaluate(input_fn=lambda: input_fn(te_files, num_epochs=1, batch_size=FLAGS.batch_size), steps=200)
