...
tf.flags.DEFINE_string("input_dir", "./", "input dir")
tf.flags.DEFINE_string("output_dir", "./", "output dir")
tf.flags.DEFINE_integer("threads", 16, "threads num")
...
Common_Fileds = {'101': 1, '121': 2, '122': 3, '124': 4, '125': 5, '126': 6, '127': 7, '128': 8, '129': 9, '205': 10,
                 '301': 11}
