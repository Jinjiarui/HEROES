...
def running_heroes(running_round, l2_weight, lr, grad_clip, batch_size, device, keep_prob, 
...
if __name__ == "__main__":
    ...
    device = "/cpu:*"
    running_heroes(args.traininground, args.l2weight, args.learningrate, args.gradclip, args.batchsize, device, 
